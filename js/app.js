    ...
    style: {
      ...
      sources: {
        "osm-placeholder": {
          ...
          tileSize: 256,
          attribution: "Placeholder basemap — to be replaced by QGIS/PMTiles export"
        }
      },
      layers: [{ id: "osm-placeholder", type: "raster", source: "osm-placeholder" }]
    },
    center: [5, 50],
    zoom: 3.2
  });
